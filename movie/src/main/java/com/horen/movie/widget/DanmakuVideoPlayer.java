package com.horen.movie.widget;
...
import com.horen.movie.adapter.BiliDanmukuParser;
import com.horen.movie.adapter.DanamakuAdapter;
...
public class DanmakuVideoPlayer extends StandardGSYVideoPlayer {
    ...
    public int getLayoutId() {
        return R.layout.movie_danmaku_layout;
    }
     ...
     * 模拟添加弹幕数据
     */
    public void addDanmaku(String danmuString, boolean islive) {
